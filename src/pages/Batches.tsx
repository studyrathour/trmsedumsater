      ...
      <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4 pb-20 md:pb-4">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-400 mb-6 leading-relaxed">
            The batches page is taking longer than expected to load. This might be due to network issues.
          </p>
      ...
      {isLoading && (
        <div className="fixed inset-0 bg-gray-900 flex items-center justify-center z-50">
          <div className="text-center">
            ...
            <h2 className="text-xl font-bold text-white mb-2">Loading Batches</h2>
